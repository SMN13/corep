looker.plugins.visualizations.add({
    ...
    updateAsync: function (data, element, config, queryResponse, details, done) {
      ...
      generatedHTML += "<th class='table-header' style='border: 1px solid black;background-color: #eee;font-family: Verdana;font-weight: normal;height:100px;'>Type of Code<hr style='margin: 0;height: 0.6px;position: absolute;width: 100%;background-color: black;'></th>";
      generatedHTML += "<th class='table-header' style='border: 1px solid black;background-color: #eee;font-family: Verdana;font-weight: normal;height:100px;'>Name<hr style='margin: 0;height: 0.6px;position: absolute;width: 100%;background-color: black;'></th>";
