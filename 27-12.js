looker.plugins.visualizations.add({
    ...
    updateAsync: function (data, element, config, queryResponse, details, done) {
      ...
      generatedHTML += "<th class='table-header' colspan='8' style='font-weight: bold;height:19px;width: -webkit-fill-available; position: absolute'>COUNTERPARTY IDENTIFICATION<hr style='margin: 0;height: 0.6px;position: absolute;width: 6.5%; background-color: red;'></th>";
      generatedHTML += "</tr>";
      generatedHTML += "<tr class='table-header'>";
