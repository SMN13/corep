looker.plugins.visualizations.add({
  ...
  updateAsync: function (data, element, config, queryResponse, details, done) {
    ...
    generatedHTML += `<th class='table-header' colspan='14' style='border: 1px solid black;background-color: #eee;font-family: Verdana;height:25px;'><hr style="background-color: #eee;margin: 0;position: absolute;height: 0.6px;top: 55px;width:37.89%;background-color: #262d33;left: 442px;"></th>`;
