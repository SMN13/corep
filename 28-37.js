looker.plugins.visualizations.add({
  ...
  addDownloadButtonListener: function () {
    ...
    downloadButton.addEventListener('click', async (event) => {
      ...
      table.style.innerHTML = 'td, th { background-color: white; border: 1px solid black; font-weight: normal; font-size: 11pt; font-family: Calibri, sans-serif; mso-number-format: "\\\@"; }';
      var rows = table.rows;
