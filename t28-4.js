looker.plugins.visualizations.add({
  ...
  updateAsync: function (data, element, config, queryResponse, details, done) {
    ...
    generatedHTML += `<th class='table-header' colspan='14' style="height:25px;background-color: #eee;"><hr style="margin: 0;position: absolute;height: 0.6px;top: 55px;width:37.89%;background-color: #262d33;left: 442px;"></th>`;
    ...
    generatedHTML += `<th class='table-header' rowspan='1'>Other commitments</th>`;
    generatedHTML += `<th class='table-header' rowspan='1'>Loan commitments</th>`;
    generatedHTML += `<th class='table-header' rowspan='1'>Financial guarantees</th>`;
    generatedHTML += `<th class='table-header' rowspan='1'>Other commitments</th>`;
    generatedHTML += `<th class='table-header' rowspan='1'>(-) Loan commitments</th>`;
